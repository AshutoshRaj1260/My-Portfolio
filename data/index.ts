...
export const workExperience = [
  {
    ...
    desc: "Built a full-stack MERN video discovery platform, implementing secure authentication, complex state management, and optimized database queries.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    ...
    desc: "Engineered an advanced chat application leveraging Retrieval-Augmented Generation (RAG) and LangChain orchestration.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
  // {
  //   id: 3,
  //   title: "City Lead (GirlScript Foundation)",
  //   desc: "Coordinated local event logistics, sponsorships, and technical workflows for the multi-city Web3 AI Camp initiative.",
  //   className: "md:col-span-2",
  //   thumbnail: "/exp3.svg",
  // },
  // {
  ...
  //   desc: "Contributed code to community-driven projects, participated in developer programs, and actively collaborated on GitHub repositories.",
  //   className: "md:col-span-2",
  //   thumbnail: "/exp4.svg",
  // },
];
...
export const socialMedia = [
  {
    id: 1,
    img: "/git.svg",
    link: "https://github.com/AshutoshRaj1260",
  },
  {
    id: 2,
    img: "/link.svg",
    link: "https://www.linkedin.com/in/ashutosh-raj2003/",
  },
];
